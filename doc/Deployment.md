# Deployment Guide <br/> RuleDefinitions Microservice

RuleDefinitions microservice can be used in different deployment scenarios.
...
The RuleDefinitions microservice can also be used as a Seneca plugin.
...
```javascript
{
    ...
    "dependencies": {
        ....
        "pip-services-ruledefinitions-node": "^1.1.*",
        ...
    }
}
```
...
var plugin = new require('pip-services-ruledefinitions-node').RuleDefinitionsSenecaPlugin;
